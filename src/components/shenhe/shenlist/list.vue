                             ...
                             <div class="bbb">
                               <div class="tit">条件筛选</div>
                                   <div class="sheng data">
                                        ...
                                        <Select v-model="model1" style="width:100px" placeholder="一审状态">
                                            <Option v-for="item in cityList" :value="item.value" :key="item.value">{{ item.label }}</Option>
                                        </Select>
                                        <Select v-model="model1" style="width:100px" placeholder="二审状态">
                                            <Option v-for="item in cityList" :value="item.value" :key="item.value">{{ item.label }}</Option>
                                        </Select>
                                   </div>
                                    ...
                                    <div>
                                        <Select v-model="model1" style="width:100px" placeholder="项目类型">
                                            <Option v-for="item in cityList" :value="item.value" :key="item.value">{{ item.label }}</Option>
                                        </Select>
...
<style scoped  lang="scss">
     .aaa{
      width: 100%;height: 140px;display:flex;justify-content:space-between;overflow: hidden;
      .bbb{
        width: 100%;height: 130px;background:#F5F7F9;padding-left:10px;
